...
var PopupHandler = function () {
  ...
  _createClass(PopupHandler, [{
    ...
    value: function createPopover() {
      ...
      ? $((0, _jquery2.default)(bootstrap.Popover.getOrCreateInstance(this.popoverTarget[0])._tip))
      : $((0, _jquery2.default)(this.popoverTarget.popover('getTipElement').data('bs.popover')._tip));
