                ...
                if (!DB::connect()->error) {
                    ...
                    if (!empty($invitation['user_id'])) {
                        ...
                        if (isset(Registry::load('settings')->site_notifications->on_group_invitation)) {
                            ...
                            ws_push(['update' => 'site_notification', 'user_id' => $invitation['user_id']]);
                        }
                    } else if (!empty($invitation['related_email_address'])) {
                        include('fns/mailer/load.php');

                        $invitation_link = Registry::load('config')->site_url.Registry::load('config')->group_url_path.'/'.$group_id.'/invitation/';
