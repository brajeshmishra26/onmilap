...
if (role(['permissions' => ['super_privileges' => 'core_settings']])) {
    ...
    try {
        $mysql_version = DB::connect()->query("SELECT VERSION()")->fetchColumn();
        $form['fields']->mysql_version = [
            "title" => 'MySQL Version', "tag" => 'input', "type" => 'text', "class" => 'field',
            "attributes" => ['disabled' => 'disabled'], 'value' => $mysql_version
        ];
    } catch (Exception $e) {}
    ...
    $php_extensions = [
        ...
        'intl' => [
            'title' => 'Intl PHP Extension',
        ],
        'sodium' => [
            'title' => 'Sodium PHP Extension',
        ],
        'sockets' => [
            'title' => 'Sockets PHP Extension',
        ],
        'json' => [
    ...
    if (ini_get('zlib.output_compression')) {
        $output = 'Enabled - [Kindly Disable This]';
    } else {
        $output = 'Disabled';
    }

    $form['fields']->zlib_output_compression = [
        "title" => 'Zlib Output Compression', "tag" => 'input', "type" => "text", "class" => 'field',
        "attributes" => ['disabled' => 'disabled'], 'value' => $output
    ];
