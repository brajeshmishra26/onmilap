...
$file_cache_timestamp = get_file_cache_timestamp('assets/css', true);
...
$minifiedPath = 'assets/css/combined_css_chat_page_libraries_'.$file_cache_timestamp.'.css';
...
$css_files = [
    ...
    'assets/css/chat_page/membership_info.css',
...
$minifiedPath = 'assets/css/combined_css_chat_page_'.$file_cache_timestamp.'.css';
$minifier->minify($minifiedPath);
...
$minifiedPath = 'assets/css/combined_css_chat_page_deferred_'.$file_cache_timestamp.'.css';
$minifier->minify($minifiedPath);
...
$css_files = [
    'assets/thirdparty/bootstrap/bootstrap.min.css',
    'assets/thirdparty/animate/animate.min.css',
    'assets/thirdparty/intl-tel-input/css/intlTelInput.css'
];
...
$minifiedPath = 'assets/css/combined_css_entry_page_libraries_'.$file_cache_timestamp.'.css';
$minifier->minify($minifiedPath);
...
$minifiedPath = 'assets/css/combined_css_entry_page_'.$file_cache_timestamp.'.css';
$minifier->minify($minifiedPath);
...
$minifiedPath = 'assets/css/combined_css_landing_page_libraries_'.$file_cache_timestamp.'.css';
$minifier->minify($minifiedPath);
...
$minifiedPath = 'assets/css/combined_css_landing_page_'.$file_cache_timestamp.'.css';
$minifier->minify($minifiedPath);
