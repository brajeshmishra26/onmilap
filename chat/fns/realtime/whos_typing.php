...
if ($check_typing_status) {
    ...
    $where["typing_status.user_id[!]"] = $current_user_id;
    ...
    if ((int)$whos_typing_last_logged_user_id !== (int)$data["whos_typing_last_logged_user_id"] || Registry::load('settings')->realtime_mode === 'websocket') {
