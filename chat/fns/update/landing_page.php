...
if (role(['permissions' => ['super_privileges' => 'core_settings']])) {
    ...
    $required_fields = [
        ...
        'packages_section_heading', 'packages_section_description',
    ...
    if ($noerror) {
        ...
        language(['edit_string' => 'landing_page_packages_section_heading', 'value' => $data['packages_section_heading'], 'language_id' => $language_id]);
        language(['edit_string' => 'landing_page_packages_section_description', 'value' => $data['packages_section_description'], 'language_id' => $language_id]);
        ...
        if (isset($data['packages_section_status']) && $data['packages_section_status'] !== Registry::load('settings')->packages_section_status) {

            if (!in_array($data['packages_section_status'], $status)) {
                $data['packages_section_status'] = 'enable';
            }

            DB::connect()->update("settings",
                ["value" => $data['packages_section_status'], "updated_on" => Registry::load('current_user')->time_stamp],
                ["setting" => 'packages_section_status']
            );
        }

        if (isset($data['show_group_members_count']) && $data['show_group_members_count'] !== Registry::load('settings')->show_group_members_count) {

            if (!in_array($data['show_group_members_count'], $status)) {
                $data['show_group_members_count'] = 'enable';
            }

            DB::connect()->update("settings",
                ["value" => $data['show_group_members_count'], "updated_on" => Registry::load('current_user')->time_stamp],
                ["setting" => 'show_group_members_count']
            );
        }

        if (isset($data['footer_section_status']) && $data['footer_section_status'] !== Registry::load('settings')->footer_section_status) {

            if (!in_array($data['footer_section_status'], $status)) {
                $data['footer_section_status'] = 'enable';
            }

            DB::connect()->update("settings",
                ["value" => $data['footer_section_status'], "updated_on" => Registry::load('current_user')->time_stamp],
                ["setting" => 'footer_section_status']
            );
        }
        ...
        if ($data['no_of_groups_landing_page'] !== Registry::load('settings')->no_of_groups_landing_page) {
            DB::connect()->update("settings",
                ["value" => $data['no_of_groups_landing_page'], "updated_on" => Registry::load('current_user')->time_stamp],
                ["setting" => 'no_of_groups_landing_page']);
        }
