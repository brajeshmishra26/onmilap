...
if (role(['permissions' => ['audio_player' => 'listen_music']])) {
    ...
    if (!isset($audio['streaming_server'])) {
        $audio['streaming_server'] = 'other';
    }
                ...
                <div class="audio_player_controls">
                    ...
                    <div>
                        <div class="controls">
                            ...
                            <span class="play_btn play_audio" hls_stream="<?php echo $audio['hls_stream']; ?>" streaming_server="<?php echo $audio['streaming_server']; ?>" audio_type="<?php echo $audio['audio_type']; ?>" audio_content_id="<?php echo $audio['audio_content_id']; ?>"><i class="bi bi-play-fill"></i></span>
