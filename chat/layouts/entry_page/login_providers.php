        ...
        <div>
            ...
            <ul>
                ...
                foreach ($login_providers as $login_provider) {
                    ...
                    $social_login_link = Registry::load('config')->site_url.Registry::load('config')->authentication_page_url_path.'/social_login/?social_login_provider_id='.$login_provider['social_login_provider_id'];
