            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-9 box_contents">
                        <h3>Installer</h3>
                        <p class="mb-4">
                            Thanks for purchasing Grupo Chat.
                            Please feel free to reach us via hello@baevox.com if you have any questions, comments, or concerns.<br><br>
                            <strong>Please Note</strong> that each license permits installation on a single end product only.
                        </p>
