<footer class="footer">
    ...
    <div class="container">
            ...
            <div class="col-6 col-lg-4 first_block">
                <div class="logo">
                    <?php if (Registry::load('current_user')->color_scheme === 'dark_mode') {
                        ?>
                        <img loading="lazy" src="<?php echo Registry::load('config')->site_url.'assets/files/logos/landing_page_footer_logo_dark_mode.png'.$cache_timestamp; ?>" />
                        <?php
                    } else {
                        ?>
                        <img loading="lazy" src="<?php echo Registry::load('config')->site_url.'assets/files/logos/landing_page_footer_logo.png'.$cache_timestamp; ?>" />
                        <?php
                    } ?>
                </div>
        ...
        <div class="switch_languages dropdown_button">
            <?php include 'layouts/landing_page/languages.php'; ?>
        </div>
